  ...
  return (
    <Container size="sm">
      ...
      <Stack>
        ...
        {loadingMyCourses && <Loader variant="dots"/>}</Paper>
        <Footer year="2023" fullName="Nunnapat Sirithanachokpaisan" studentId="650610776" />
      </Stack>
    </Container>
  );
}
